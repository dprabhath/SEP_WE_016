 ...
 * Generated for Laravel 5.1.31 (LTS) on 2016-05-01.
 *
...
namespace {
    ...
    class Captcha extends \Arcanedev\NoCaptcha\Facades\NoCaptcha{
        ...
        public static function display($attributes = array()){
            return \Arcanedev\NoCaptcha\NoCaptcha::display($attributes);
        }
         ...
         * @static 
         */
        public static function image($attributes = array()){
            return \Arcanedev\NoCaptcha\NoCaptcha::image($attributes);
        }
         ...
         * @static 
         */
        public static function audio($attributes = array()){
            return \Arcanedev\NoCaptcha\NoCaptcha::audio($attributes);
        }
    ...
    class SMS extends \SimpleSoftwareIO\SMS\Facades\SMS{
        ...
        public static function driver($driver){
            return \SimpleSoftwareIO\SMS\SMS::driver($driver);
        }
         ...
         * @static 
         */
        public static function pretend($view, $data, $callback){
            return \SimpleSoftwareIO\SMS\SMS::pretend($view, $data, $callback);
        }
         ...
         * @static 
         */
        public static function setPretending($pretend = false){
            return \SimpleSoftwareIO\SMS\SMS::setPretending($pretend);
        }
        
        /**
         * Sets the IoC container
         *
         * @param \SimpleSoftwareIO\SMS\Container $container
         * @static 
         */
        public static function setContainer($container){
            return \SimpleSoftwareIO\SMS\SMS::setContainer($container);
        }
         ...
         */
        public static function setLogger($logger){
            return \SimpleSoftwareIO\SMS\SMS::setLogger($logger);
        }
         ...
         */
        public static function handleQueuedMessage($job, $data){
            \SimpleSoftwareIO\SMS\SMS::handleQueuedMessage($job, $data);
        }
         ...
         */
        public static function setQueue($queue){
            return \SimpleSoftwareIO\SMS\SMS::setQueue($queue);
        }
        ...
        public static function receive(){
            return \SimpleSoftwareIO\SMS\SMS::receive();
        }
         ...
         * @static 
         */
        public static function checkMessages($options = array()){
            return \SimpleSoftwareIO\SMS\SMS::checkMessages($options);
        }
        ...
        public static function getMessage($messageId){
            return \SimpleSoftwareIO\SMS\SMS::getMessage($messageId);
        }
