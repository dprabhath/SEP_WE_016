                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                @if($user->level>4)
                                <li class="hidden-xs"><a href="{{ url('/') }}/admin/view-ticket">Dashboard</a></li>
                                @endif
                                @endif
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown-header hidden-md hidden-lg hidden-sm"><span class="glyphicon glyphicon-envelope"></span> Tickets</li>
                                        ...
                                        <li class="hidden-md hidden-lg hidden-sm"><a href="{{ url('/') }}/doctors"> Physicians</a></li>
                                        <li class="hidden-md hidden-lg hidden-sm"><a href="{{ url('/') }}/treatments"> Treatments</a></li>
                                        @if($user->level>4)
                                        <li class="divider"></li>
                                        <li class="hidden-md hidden-lg hidden-sm"><a href="{{ url('/') }}/admin/view-ticket"><span class="glyphicon glyphicon-dashboard"></span> Dashboard</a></li>
                                        @else
                                        @if($user->verified==1)
